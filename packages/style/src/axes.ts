...
// ПЕЧАТИ В ЛИСТ ЗДЕСЬ БОЛЬШЕ НЕТ (`PWEB-66`). Была `axesCss()` — комментарий с границами осей,
// уезжавший в базовый слой. Комментарий в чужом файле знанием не является: его не прочтёт
// машина и не найдёт тот, кто строит ползунок.
//
// `AXES` остаются данными на поверхности — знание о том, где у значения край, нужно именно
// строящему ползунок, и нужно значением.

 ...
 * `"radioGroupPassport"`. Rendered barrels use this so the identifier a
 * folder gets is a pure function of its name, not a second name chosen by
 * hand that can drift from the first.
 */

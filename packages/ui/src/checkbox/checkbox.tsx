...
// несёт — паспорт объясняет это в `checkbox.anatomy.ts`, здесь же его просто пропускают насквозь.
 ...
 *
 * Адреса не несёт (`checkbox.anatomy.ts`, «Скрытый ввод — без адреса»): часть, которую

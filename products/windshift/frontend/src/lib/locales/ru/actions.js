...
export default {
  actions: {
    ...
    templates: {
      ...
      help: 'Примените готовый шаблон автоматизации к этому рабочему пространству. Каждое применение создаёт новое действие, которое можно отредактировать позже.',
      apply: 'Применить',
    },
    ...
    manualAccess: {
      ...
      restrictedHint:
        'Видеть и запускать это действие могут только участники хотя бы с одной из выбранных ролей. Администраторы рабочего пространства всегда сохраняют доступ.',
    },
    ...
    config: {
      ...
      noCapabilitiesForWorkspace:
        'В этом рабочем пространстве нет доступных возможностей. Попросите администратора подключить их.',
      ...
      agentToolsHint:
        'Возможности HTTP-клиента, которые может вызывать агент. Показаны только возможности, доступные в этом рабочем пространстве.',
      noToolsAvailable: 'Для этого рабочего пространства нет доступных возможностей HTTP-клиента.',

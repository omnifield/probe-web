// Гейт ОБЯЗАТЕЛЬСТВА по `data-slot` (`PROBEWEB-12`, пункт 7).
//
 ...
 * несколько (`PROBEWEB-4`, форма читается `[data-slot~="…"]`). Взять значение целиком
...
describe("обещанные зацепки доезжают до документа", () => {
  ...
  it("в перечне нет повторов — иначе равенство выше сошлось бы вслепую", () => {
    ...
    // обещание — нет. Ровно по этой причине architect убрал его и из `PROBEWEB-11`

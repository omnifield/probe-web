...
// ЗДЕСЬ БЫЛИ образцы чужих форм (FOREIGN/FLAT/NESTED_RESPONSE), переходники под них и SOURCES/
// DemoSource — сняты вместе с `src/adapter/` (постановка user, 2026-08-29): переходник данных
// переехал в `packages/io`, универсальным, не завязанным на таблицы (PWEB-180..183). Своей
// копии-демонстрации здесь больше не заводим — история осталась в git.

      ...
      children: [
        {
          node: "list",
          children: [
            { node: "trigger", props: { value: "account" }, children: [{ genus: "text", value: "Аккаунт" }] },
            { node: "trigger", props: { value: "billing" }, children: [{ genus: "text", value: "Оплата" }] },
            { node: "trigger", props: { value: "settings" }, children: [{ genus: "text", value: "Настройки" }] },
            { node: "indicator" },
          ],
        },
        { node: "content", props: { value: "account" }, children: [{ genus: "text", value: "Имя, почта, пароль." }] },
        { node: "content", props: { value: "billing" }, children: [{ genus: "text", value: "Карта и история платежей." }] },
        { node: "content", props: { value: "settings" }, children: [{ genus: "text", value: "Язык, тема, уведомления." }] },
      ],
    },
  },
];

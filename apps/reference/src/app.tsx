// Экран эталонного приложения — ГЕЙТ, а не витрина (`tasker:PROBEWEB-14`).
//
...
// класс собирается `createStyle` стилевого слоя. Каждая строка здесь стоит потому, что через
// неё проходит шов, — украшений в файле нет.
//
...
import { createStyle, createThemeController, cva } from "@omnifield/probe-web-style";
import {
  Button,
  Field,
  FieldDescription,

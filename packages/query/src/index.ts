// Единственная точка входа в данные из сети probe-web (PROBEWEB-4): приложение не импортирует
...
// приведён как рекомендуемый в примерах README ради единообразия с остальным кодом probe-web.

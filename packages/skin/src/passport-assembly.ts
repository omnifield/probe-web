...
//
// Дом переехал вместе с формой (`PWEB-110`, пересматривает `PWEB-26`): ни объявление сборки, ни
// её разворот в плоское дерево не завязаны на конкретный кит — общая механика, а не особенность
// Ark/Zag. Разбор критерия — в шапке `passport-form.ts`.
//
// ## Что это чинит
//

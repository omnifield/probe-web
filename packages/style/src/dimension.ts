...
export const DERIVED_SCALES: readonly DerivedScale[] = [
  ...
  },
  {
    ...
    // Решение — `PROBEWEB-16`, часть Б. Переименование ЛОМАЮЩЕЕ и сделано разом: устаревших
  ...
  },
  {
    ...
    // вывода, — фикция, только записанная (`PROBEWEB-16`, «Шкала ширин поверхностей»).
    //
 ...
 * Тот же довод отправил на сборку относительный синтаксис цвета (`PROBEWEB-12`, часть 3);

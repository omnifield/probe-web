...
// отрендеренный узел в `#root` (DoD задачи `PROBEWEB-11`). «Функция экспортируется» и
...
describe("механика скина и живое дерево", () => {
  ...
  // утверждения — про ГРАНИЦУ механики, и оба названы в `PROBEWEB-13` главным условием.

...
export interface AssemblyNode {
   ...
   *
   * При композиции они уезжают ВНЕШНЕМУ: он рисует узел и передаёт остаток внутреннему сам
 ...
 * @param node узел
 */
export function outerTypeOf(node: AssemblyNode): string {
  return node.composedInto ?? node.type;
}

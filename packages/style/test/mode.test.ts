...
// ГЕЙТ «РЕЖИМ ПРИНАДЛЕЖИТ СКИНУ» (`PWEB-50`). Мерим ЖИВЫМ ДОКУМЕНТОМ, а не чтением файла:
// вопрос задачи — «меняется ли хоть одно значение», а на него отвечает каскад, а не текст.
...
describe("приложение БЕЗ скина", () => {
  ...
  it("базовый слой объявляет способность к обоим режимам, а не один из них", () => {

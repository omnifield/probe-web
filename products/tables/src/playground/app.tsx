...
//
// Не витрина (витрина это зона `studio`) и не эталон. Страница «Переходник» снята вместе с
// `src/adapter/` (постановка user, 2026-08-29): переходник данных переехал в `packages/io`,
// универсальным, не завязанным на таблицы (PWEB-180..183) — своей копии движка здесь больше не
// заводим, привязку `tables` к новому пакету делает отдельный, ещё не начатый заход (PWEB-185).
//

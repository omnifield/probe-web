...
//
// Ролей было две: перечень и подпуть `@omnifield/probe-web-style/values`. Подпуть снят
...
//
// ЭТО ПОВЕРХНОСТЬ, И ОНА ЗАМЕРЗАЕТ. Что попало сюда, то обещано (`kb:PROBEWEB-4`): каждый

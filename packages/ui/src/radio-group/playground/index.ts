...
//
// EDITOR-ONLY metadata for the radio group. Human-facing text, taxonomy, and nesting rules for
...
// (`genus: "component"`), grouped with the checkbox/switch as an input — `group: "inputs"`, the
// same group the checkbox already claims. `variantAxis.means` is prose — left as "TODO" for
...
export const editorInfo = /*@__PURE__*/ defineEditorInfo(passport, {
  ...
  footprint: "regular",
  variantAxis: {
    means: "the variant name a human gives the radio group in the editor; the kit passes it through untouched",
  },
  parts,
  settings,
  assemblies,

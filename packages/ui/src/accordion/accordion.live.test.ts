...
//
// Разметку рисует ОБЪЯВЛЕННАЯ КИТОМ сборка (первая из `editorInfo.assemblies`, `../../test/
// kit-live.js`), а не разметка, написанная пробой, — иначе проверялось бы наше представление о
// ките, а не кит.

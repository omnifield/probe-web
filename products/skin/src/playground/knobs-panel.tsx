    ...
    <div class="knobs">
      ...
      <Show
        ...
        fallback={
          <p class="knobs__refusal">
            {k().trouble() ?? "служба не отвечает"} — перечень пуст и вид не подключён: компоненты
            работают на умолчаниях базы. Сохранить пресет сейчас нельзя. Поднять службу:{" "}
      ...
      >
        ...
        <Show
          ...
          fallback={
            <p class="knobs__refusal">
              служба отвечает, но пресетов в ней нет — вид не подключён. Вернуть семя:{" "}
              <code>pnpm run seed:presets</code>
            </p>
          }
        >

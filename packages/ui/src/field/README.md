...
> [!NOTE]
> 🧬 Field — единственный компонент кита без стейт-машины под собой: анатомия взята напрямую из
> Ark, без промежуточного движка. Вся работа компонента — развести один `<label>`, один контрол,

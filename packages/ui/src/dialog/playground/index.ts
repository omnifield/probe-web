...
// comment already names (`PWEB-34`) — a dialog is not `disclosure` (accordion's own section:
// expand/collapse in place, not a floating panel) and no better-fitting section exists yet.

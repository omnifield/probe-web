...
// dialog's/scroll area's own comment already names (`PWEB-34`) — an avatar is not `disclosure`
// and no better-fitting section exists yet. `footprint` is real too (`footprintOf`, `PWEB-31`):
// `"compact"` — a small atom, the same bracket the icon/checkbox already sit in, not the middle
// default a structural component gets.

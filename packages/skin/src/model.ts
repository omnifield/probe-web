...
// им нужны форма и отказы, но не нужен плоский текст CSS. А за текстом стоит `@pandacss/core` с
// postcss в придачу: влей мы всё в один вход, каждый такой потребитель ставил бы postcss ради

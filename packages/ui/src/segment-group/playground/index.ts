...
//
// EDITOR-ONLY metadata for the segment group. Human-facing text, taxonomy, and nesting rules for
...
// (`genus: "component"`), grouped with the checkbox/switch/radio-group/toggle-group as an input —
// `group: "inputs"`, the same rationale. `footprint` is real too (`footprintOf`, `PWEB-31`):
// `"compact"` — the same small-atom bracket the toggle group's own row of buttons already sits
// in, not the middle default a structural component like the radio group gets.

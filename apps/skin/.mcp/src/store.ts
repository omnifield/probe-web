...
// `apps/skin/src/entities/outfit/api/store.ts`, не переиспользование того файла: тот читает
 ...
 * браузерный клиент (`replace`, `apps/skin/src/entities/outfit/api/store.ts`): обратный

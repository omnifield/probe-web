...
// Из Solid-обвеса движка стилей приезжает механика сборки класса, и только она (`PWEB-3`).
...
//
// Из корня набора значений сюда не приезжает НИЧЕГО (`PWEB-52`): контроллер темы отсюда ушёл

...
//
// Правило шва (`PROBEWEB-8`): бэк ХРАНИТ, зона ПОНИМАЕТ. Хранилище принимает непрозрачный
...
// адреса (`PROBEWEB-4`, `PROBEWEB-5`). Ходящая по сети реализация живёт в площадке.
...
/**
 * Ограничители — в первой же версии, а не «потом» (`PROBEWEB-8`).
 *

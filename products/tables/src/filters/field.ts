...
// (`tasker:TABLES-4`, раздел D): у точечной нотации нет механизма экранирования — имя поля с
 ...
 *
 * НАШЕ решение, рынком не подтверждённое (`tasker:TABLES-4`, раздел G): protobuf нормирует

...
export const DERIVED_SCALES: readonly DerivedScale[] = [
  ...
  },
  {
    ...
    snap: true,
    basis:
      "сетка 0.25rem — семя равно шагу сетки, ступени кратны ему (1·2·3·4·6·8·12·16·24·32); после умножения плотностью значение возвращается на ту же сетку 0.25rem",
    steps: [

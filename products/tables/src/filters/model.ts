...
// заимствовать вместо нашей формы нечего, решение остаётся нашим (`tasker:TABLES-4`, H.5).
//
...
// условие по наличию поля. Сверено 2026-08-11, разбор — `tasker:TABLES-4`, раздел C.
 ...
 * PostgREST `like`/`fts`), и сливать их в один оператор нельзя (`tasker:TABLES-4`, H.3).
 */
...
export interface FilterState {
   ...
   * форму он держит в руках (`tasker:TABLES-4`, раздел F).
   */

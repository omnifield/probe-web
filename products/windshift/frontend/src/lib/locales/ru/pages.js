...
export default {
  pages: {
    ...
    moveWorkspaceLabel: 'Целевой воркспейс',
    moveWorkspacePlaceholder: 'Выберите воркспейс…',
    moveParentLabel: 'Родительская страница',
    moveSearchPlaceholder: 'Поиск страниц…',
    moveRoot: 'Корень воркспейса',
    ...
    moveCancel: 'Отмена',
    errorLoadWorkspaces: 'Не удалось загрузить воркспейсы',
    ...
    permsInheritHint:
      'Если наследование включено и явных прав нет, доступ определяется ролью в воркспейсе. Отключение наследования без явных прав ограничивает доступ к странице только администраторами.',
    permsExplicitGrants: 'Явные права доступа',
    permsEmptyGrantsTitle: 'На этой странице нет явных прав доступа.',
    permsEmptyGrantsDescription: 'Наследование и роли воркспейса всё равно применяются.',
    ...
    // Метки страниц (в рамках воркспейса, привязываются только к страницам)
    labelsTitle: 'Метки',
